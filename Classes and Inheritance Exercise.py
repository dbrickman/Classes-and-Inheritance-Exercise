...
class Fish(Animal):
    ...
    @freshwater.setter
    def freswater(self, new_freshwater):
        self.__freshwater = new_freshwater


class Book():
    """Book Class"""

    def __init__(self, title, author, length, date_published, genre):
        print('Creating book')
        self.__title = title
